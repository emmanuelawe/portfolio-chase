    ...
    z-10 p-2 text-white"
      ...
      <div className="max-w-[1240px] mx-10 p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p className="pt-6">
            This build is a simple blog built using Next JS, Chakra UI (with the
            implementation of Dark Mode) and Mongo DB to make the overall
            experience while using the web app seamless.
          </p>
          <a
            href="https://chase-blog.vercel.app"
            target="_blank"
          ...
          <a
            href="https://github.com/emmanuelawe/chaseblog"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="col-span-4 md:col-span-1 shadow-lg shadow-gray-400 rounded-xl p-4">
          <div className="p-2">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1">
              ...
              <p className="text-[#434346] py-2 flex items-center">
                <MdOutlineRadioButtonChecked /> Mongo DB
              </p>
            </div>
          </div>
        </div>
