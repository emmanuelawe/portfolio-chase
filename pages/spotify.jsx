...
const netflix2 = () => {
  return (
    ...
    <div className='col-span-4'>
          ...
          <p className='pt-6'>
            This build was modelled after Spotify&apos;s website. It&apos;s a premium music streaming website 
            that uses Spotify authentication for signin.
          </p>
          <p className='pt-2'>
            It was built using Next JS, Javascript to make the overall experience while 
            using the web app seamless.
          </p>
          <Link href='https://spotifyui-chase.vercel.app'>
          <button className='px-8 py-2 mt-4 mr-8'>Demo</button>
          </Link>
          <Link href='https://github.com/emmanuelawe/spotify-chase'>
    ...
    <div className='grid grid-cols-2 md:grid-cols-1'>
        ...
        <p className='text-[#434346] py-2 flex items-center'><MdOutlineRadioButtonChecked/> Spotify Api</p>
    </div>
    </div>
    </div>
    <Link href='/#projects'>
