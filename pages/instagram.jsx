...
const instagram = () => {
  return (
    ...
    <Image className='absolute z-1' layout='fill' objectFit='cover' src={Instagram} alt='' />
    ...
    <div className='col-span-4'>
          ...
          <p className='pt-6'>
            ...
            authentication for signin for sign in. Firebase is the database used to store data and other details.
          </p>
          <p className='pt-2'>
            It was built using Next JS, JavaScript and Firebase to make the overall experience while 
            using the web app seamless.
          </p>

          
          <Link href='https://insta-chase.vercel.app'>
          <button className='px-8 py-2 mt-4 mr-8'>Demo</button>
          </Link>
          <Link href='https://github.com/emmanuelawe/insta-chase'>
