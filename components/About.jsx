...
const About = () => {
  return (
    ...
    <div className='max-w-[1152px] 2xl:max-w-[1240px] m-auto md:grid grid-cols-3 gap-8'>
    <div className='col-span-2'>
    <p className='uppercase text-2xl pb-10 tracking-[15px] text-center font-medium text-[#0e61c9]'>About</p>
    <p className='py-2 text-[#434346] px-2 '>Not your average developer.</p>
    <p className='py-2 text-[#434346] px-2 text-justify'>
